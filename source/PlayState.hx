	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'sussy':
				defaultCamZoom = 0.9;
				curStage = 'sussy';
				var bg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('123456789'));
		...
		switch(curStage)
		{
			...
			case 'sussy':
				...
				//dad.scale.x = 1.3;
				//dad.scale.y = 1.3;
				//boyfriend.scale.x = 1.1;
				//boyfriend.scale.y = 1.1;
				gf.x += 200;
				dad.x += 250;
				boyfriend.x += 250;
				//dad.x -= 150;
			...
			notes.forEachAlive(function(daNote:Note)
			{
				...
				if (!daNote.mustPress && daNote.wasGoodHit && !daNote.hitByOpponent && !daNote.ignoreNote)
				{
					...
					if(daNote.noteType == 'Hey!' && dad.animOffsets.exists('hey')) {
						...
						if(ClientPrefs.camnote){
							switch (Math.abs(daNote.noteData))
							{
								case 0: camFollow.x -= 15; camFollow.y += 0.01;
								case 1: camFollow.y += 15; camFollow.x += 0.01;
								case 2: camFollow.y += -15;camFollow.x += 0.01;
								case 3: camFollow.x += 15; camFollow.y += 0.01;
							}
						}
