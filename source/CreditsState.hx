...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Vs Mini Red Team'],
		['์G land | Channel',	'g',		'Owner/Art/Music',						'https://www.youtube.com/channel/UCY_M7b7-aOV4oeJ9Exgh7gQ',	FlxColor.fromRGB(204,222,243)],
		['FTH_YT',					'FTH_YT',			'Art',			'https://www.youtube.com/channel/UCj0pBFqcLcp8o32EMkb6eGw',	FlxColor.fromRGB(144,144,144)],
		['์Nong vanila',		'nong',		'Coder/animation/chart',					'https://www.youtube.com/channel/UCGwph3rtuvm9D7yvjceZBbg',	FlxColor.fromRGB(125,147,186)],
		['Psych Engine Team'],
